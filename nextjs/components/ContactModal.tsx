...
import { sendJoinParty } from "@/lib/ws/client";
import type { ContactMethod } from "@/lib/types";
import { StarIcon } from "@heroicons/react/20/solid";
import { PhoneIcon, UserIcon } from "@heroicons/react/24/outline";
import { normalizeDiscordUrl, extractSteamID64 } from "@/lib/utils/contactHelpers";
        ...
        {contacts.length === 0 ? (
          ...
          <div className="space-y-3">
            {contacts.map((contact) => {
              const normalizedUrl = normalizeDiscordUrl(contact, undefined);
              const steamID64 = extractSteamID64(contact, undefined);
